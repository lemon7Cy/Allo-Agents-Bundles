...
Use this skill whenever the user explicitly requests PDF, Word, or DOCX, including when another content skill such as `report-writing` is also needed. Use the content skill to finish the document, then use this renderer to create the real requested file in the same turn.
