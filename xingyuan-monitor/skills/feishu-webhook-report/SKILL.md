...
```json
{
  ...
  "card": {
    ...
    "header": {
      "template": "blue",
      "title": { "tag": "plain_text", "content": "星元监控 | 日报" }
    },
    "elements": []
  }
}
...
```json
{
  ...
  "card": {
    ...
    "header": {
      "template": "blue",
      "title": { "tag": "plain_text", "content": "星元监控 | 2026-06-16" }
    },
    "elements": [
      {
        "tag": "markdown",
        "content": "<text_tag color=\"blue\">状态</text_tag> 正常\n<text_tag color=\"blue\">窗口</text_tag> 2026-06-16 Asia/Shanghai\n<text_tag color=\"blue\">概述</text_tag> MaaS 流量平稳;DFCode 用量集中在 gpt-5.5。"
      },
      { "tag": "hr" },
      {
        "tag": "markdown",
        "content": "**关键指标**\n<text_tag color=\"blue\">请求数</text_tag> 2,439\n<text_tag color=\"blue\">Token</text_tag> 30.67M\n<text_tag color=\"blue\">费用</text_tag> 917.55\n<text_tag color=\"blue\">Top 模型</text_tag> gpt-5.5"
      },
      { "tag": "hr" },
      {
        "tag": "markdown",
        "content": "**诊断**\n- MaaS 健康正常。\n- DFCode 用量与 MaaS token 趋势一致。\n- 反馈与审计日志未见确认的事件。"
      },
      {
        "tag": "note",
        "elements": [
          { "tag": "plain_text", "content": "由星元监控生成,经人工确认后发送。" }
        ]
      }
    ]
  }
...
```json
{
  ...
  "card": {
    ...
    "header": {
      "template": "red",
      "title": { "tag": "plain_text", "content": "星元告警 | MaaS 错误激增" }
    },
    "elements": [
      {
        "tag": "markdown",
        "content": "<text_tag color=\"red\">严重度</text_tag> 高\n<text_tag color=\"blue\">范围</text_tag> public-maas / gpt-5.5\n<text_tag color=\"blue\">信号</text_tag> 近 15 分钟上游 429 增多"
      },
      { "tag": "hr" },
      {
        "tag": "markdown",
